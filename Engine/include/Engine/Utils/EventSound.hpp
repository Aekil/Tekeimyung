...
#define EVENT_SOUND(PROCESS)\
    PROCESS(BACKGROUND_MENU, BACKGROUND_SOUND),\
    ...
    PROCESS(PLAYER_SHOOT_GUN, DEFAULT_SOUND),\
    PROCESS(PLAYER_SHOOT_ELEC, DEFAULT_SOUND),\
    PROCESS(PLAYER_SHOOT_LAZR, DEFAULT_SOUND),\
    PROCESS(EARN_COINS_FROM_ENEMY, DEFAULT_SOUND),\
    PROCESS(ENEMY_HIT_CASTLE, DEFAULT_SOUND),\
    PROCESS(DEFEAT_SCREEN, DEFAULT_SOUND),\
    PROCESS(VICTORY_SCREEN, DEFAULT_SOUND),\
