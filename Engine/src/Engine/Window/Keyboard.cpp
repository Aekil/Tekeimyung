...
Keyboard::Keyboard()
{
    ...
    this->_nativeMap[GLFW_KEY_A] = Keyboard::eKey::A;
    ...
    this->_nativeMap[GLFW_KEY_Q] = Keyboard::eKey::Q;
    ...
    this->_nativeMap[GLFW_KEY_W] = Keyboard::eKey::W;
    this->_nativeMap[GLFW_KEY_X] = Keyboard::eKey::X;
    this->_nativeMap[GLFW_KEY_Y] = Keyboard::eKey::Y;
    this->_nativeMap[GLFW_KEY_Z] = Keyboard::eKey::Z;
